...
import static com.mohnage7.bakingapp.recipedetails.StepsFragment.STEP;
...
public class StepsActivity extends AppCompatActivity implements ExoPlayer.EventListener {
     ...
     */
    private void hideCollpaseTitle() {
        appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                if (scrollRange + verticalOffset == 0) {
                    collapsingToolbarLayout.setTitle(step.getReceiptName() + getString(R.string.steps));
                    isShow = true;
                } else if (isShow) {
